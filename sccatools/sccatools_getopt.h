...
#if !defined( _SCCATOOLS_GETOPT_H )
#define _SCCATOOLS_GETOPT_H
...
typedef struct sccatools_option sccatools_option_t;

struct sccatools_option
{
...
#define sccatools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t sccatools_getopt(
                  int argument_count,
...
void sccatools_getopt_wrapped_fprint(
      FILE *stream,
...
void sccatools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const sccatools_option_t *options,
      int number_of_options );

int sccatools_getopt_get_options_string(
     const sccatools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _SCCATOOLS_GETOPT_H ) */
