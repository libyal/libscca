...
$LibraryTests = "compressed_block error file_information file_metrics filename_strings io_handle notify volume_information"
...
Function RunTest
{
	...
	$TestExecutable = "${TestExecutablesDirectory}\scca_test_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = GetTestProfileDirectory "input" "libscca"
