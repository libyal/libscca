 ...
 */
int scca_test_get_narrow_source(
     const system_character_t *source,
     char *narrow_string,
     size_t narrow_string_size,
     libcerror_error_t **error )
{
	static char *function     = "scca_test_get_narrow_source";
 ...
 * Returns 1 if successful or -1 on error
 */
int scca_test_get_wide_source(
     const system_character_t *source,
     wchar_t *wide_string,
     size_t wide_string_size,
     libcerror_error_t **error )
{
	static char *function   = "scca_test_get_wide_source";
...
int scca_test_open_file_io_handle(
     ...
     libcerror_error_t **error )
{
	static char *function = "scca_test_open_file_io_handle";
...
int scca_test_close_file_io_handle(
     ...
     libcerror_error_t **error )
{
	static char *function = "scca_test_close_file_io_handle";
	int result            = 0;
