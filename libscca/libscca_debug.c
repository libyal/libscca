 ...
 */
int libscca_debug_print_filetime_value(
     ...
     libcerror_error_t **error )
{
	...
	static char *function             = "libscca_debug_print_filetime_value";
 ...
 * Returns 1 if successful or -1 on error
 */
int libscca_debug_print_utf16_string_value(
     const char *function_name,
     const char *value_name,
     const uint8_t *byte_stream,
     size_t byte_stream_size,
     ...
     libcerror_error_t **error )
{
	...
	static char *function      = "libscca_debug_print_utf16_string_value";
 ...
 * Returns 1 if successful or -1 on error
 */
int libscca_debug_print_read_offsets(
     libbfio_handle_t *file_io_handle,
     libcerror_error_t **error )
{
	static char *function = "libscca_debug_print_read_offsets";
	off64_t offset        = 0;
	size64_t size         = 0;
